...
<p style="color:#cbd5e1;margin-top:8px;">Uma questão deste bucket pede o cálculo do Ativo Não Circulante, Passivo Circulante e Patrimônio Líquido a partir de um balancete — mesmo raciocínio do tema <strong>Contabilidade Geral e Pública</strong>: classificar cada conta em ativo/passivo/PL e circulante/não circulante antes de somar.</p>
</div>`,
    questoes: []
  },
  {
...
<h3>Direito Administrativo — Atos Administrativos</h3>
<p><strong>5 elementos clássicos</strong>: competência, forma, motivo, objeto e finalidade.</p>
<p><strong>Vinculados x discricionários</strong>: atos vinculados não deixam margem de escolha; atos discricionários permitem juízo de conveniência e oportunidade — mas, ao contrário do que às vezes aparece como pegadinha, eles <strong>podem sim ser revogados pela própria Administração</strong> por conveniência e oportunidade. O que o Judiciário <strong>não pode</strong> fazer é entrar no mérito administrativo (a escolha de conveniência em si) — o controle judicial se limita à legalidade do ato.</p>
<p><strong>Decadência do direito de anular</strong>: a Administração tem <strong>5 anos</strong>, contados da prática do ato, pra anular atos administrativos dos quais decorram efeitos favoráveis a destinatários — salvo comprovada má-fé, caso em que esse prazo não corre.</p>
<p><strong>Atributos dos atos administrativos</strong> — não confundir: <strong>autoexecutoriedade</strong> é a capacidade de a Administração executar suas decisões direto, sem precisar de autorização judicial prévia (ex.: interditar uma atividade ilegal, inutilizar produto impróprio pro consumo); <strong>presunção de legitimidade</strong> é a presunção de que o ato foi praticado em conformidade com a lei, até prova em contrário — é sobre a validade do ato, não sobre a possibilidade de executá-lo sem o Judiciário.</p>`,
    questoes: []
  },
  {
